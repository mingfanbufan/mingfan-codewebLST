...
影响排行榜数据的主要包含：答题模块和统计模块，答题模块重在更新，统计模块重在统计和返回形式的转换。 ![img](https://pic.yupi.icu/5563/202401161913578.png)
...
![img](https://pic.yupi.icu/5563/202401161913283.png) 虽然总分、总耗时和总耗用空间可以根据最优答题情况（gameDetail）动态生成，但每次都要变动，尤其竟赛结束后还要动态计算时间是有点浪费了点，于是用一点空间换时间，况且，维护也不麻烦。 另外，竞赛详情（gameDetail）的对象结构如下： ![img](https://pic.yupi.icu/5563/202401161913561.png)
...
![img](https://pic.yupi.icu/5563/202401161913873.png)
...
![img](https://pic.yupi.icu/5563/202401161913586.png) 处理提交题目的代码如下（逻辑看注释)
...
![img](https://pic.yupi.icu/5563/202401161913378.png) 处理排行榜数据和排序的代码如下（逻辑看注释)
...
最终展示效果如下，可以达到尽可能显示的效果： 竞赛开始后，未答题前获取排行榜数据会设置初始值，类似下图： ![img](https://pic.yupi.icu/5563/202401161913556.png) 有用户答题后会更新排行榜数据，类似下图： ![img](https://pic.yupi.icu/5563/202401161913561.png)