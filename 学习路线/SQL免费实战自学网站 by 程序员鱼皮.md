...
![img](https://mingfanweb-img.obs.cn-north-4.myhuaweicloud.com/Learning-Path/SQL/1.png)某 B 友的评价
...
![img](https://mingfanweb-img.obs.cn-north-4.myhuaweicloud.com/Learning-Path/SQL/2.png)
...
![img](https://mingfanweb-img.obs.cn-north-4.myhuaweicloud.com/Learning-Path/SQL/3.png)

> SQL 之母使用教程

除了按照顺序过关外，大家还可以进入关卡页面自由选择关卡、自由学习，不用担心卡在一道题目上过不去、也可以不做自己觉得简单的题目。

![img](https://mingfanweb-img.obs.cn-north-4.myhuaweicloud.com/Learning-Path/SQL/4.png)

> 选择关卡

在关卡页面，我还提供了几个自定义关卡。毕竟时间和想象力有限，剧情可能比较水，大家别介意：

![img](https://mingfanweb-img.obs.cn-north-4.myhuaweicloud.com/Learning-Path/SQL/5.png)

> 自定义关卡

除了闯关外，我还提供了一个 SQL 广场功能，可以在小小的编辑器里随意输入 SQL 语句来练习~

![img](https://mingfanweb-img.obs.cn-north-4.myhuaweicloud.com/Learning-Path/SQL/6.png)
...
![img](https://mingfanweb-img.obs.cn-north-4.myhuaweicloud.com/Learning-Path/SQL/7.png)
...
![img](https://mingfanweb-img.obs.cn-north-4.myhuaweicloud.com/Learning-Path/SQL/8.png)
