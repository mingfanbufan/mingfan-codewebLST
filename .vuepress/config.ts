...
const author = "明凡";
const domain = "https://mingfancloud.cn";
...
export default defineConfig({
  ...
  head: [
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "明凡, 明凡的编程宝典, 编程学习路线, 编程知识百科, Java, 编程导航, 前端, 开发, 编程分享, 项目, IT, 求职, 面经",
      },
    ],
    // 百度统计
    [
      ...
      `
        ...
        (function() {
          ...
          hm.src = "https://hm.baidu.com/hm.js?736ac1c770910dbbc21ad429be4c4ef9";
  ...
  plugins: [
    ...
    ['vuepress-plugin-readmore-popular', {
      // 已申请的博客 ID
      blogId: '20567-9776719359463-064',
      // 已申请的微信公众号名称
      name: '小明创客',
      // 已申请的微信公众号回复关键词
      keyword: '明凡',
      // 已申请的微信公众号二维码图片
      qrcode: 'https://mingfancloud.cn/gongzhonghao.png',
